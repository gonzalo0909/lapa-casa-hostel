...
function T(key: string, locale: string): string {
  const t: Record<string, Record<string, string>> = {
    pt: {
      ...
      roomName: 'Quarto',
      description: 'Este quarto é reservado para mulheres por tempo limitado antes do check-in.',
    ...
    es: {
      ...
      roomName: 'Habitación',
      description: 'Esta habitación queda reservada para mujeres por tiempo limitado antes del check-in.',
    ...
    en: {
      ...
      roomName: 'Room',
      description: 'This room is held for women for a limited time before check-in.',
    ...
    de: {
      ...
      roomName: 'Zimmer',
      description: 'Dieses Zimmer ist für begrenzte Zeit vor dem Check-in für Frauen reserviert.',
