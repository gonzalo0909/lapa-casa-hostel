...
export type Phase = 'wizard' | 'success' | 'expired' | 'group-link';
...
export const T = {
  pt: {
    ...
    gpExpire:'O link expira em 30 minutos. Todos os integrantes devem pagar nesse prazo.',
  ...
  es: {
    ...
    gpTitle:'Un link para todo el grupo',
    gpDesc:'Reenviá este link por donde quieras. Cada persona completa sus datos y paga su cama. Cuando el último pague, la reserva se confirma automáticamente.',
