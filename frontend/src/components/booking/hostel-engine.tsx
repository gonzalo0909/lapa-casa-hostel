...
export function HostelEngine({ locale = 'pt' }: HostelEngineProps) {
  ...
  // paymentLinkError: falla al reintentar la generación del link (distinto de
  // paymentInitFailed, que es el primer intento al confirmar la reserva).
  ...
  // ─ Reintentar generación del link de pago si falló en la pantalla de éxito ─
