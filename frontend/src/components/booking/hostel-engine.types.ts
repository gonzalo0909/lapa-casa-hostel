...
export const T = {
  pt: {
    ...
    rule6:'Camas beliches de três andares: não indicadas para maiores de 50 anos ou pessoas com mobilidade reduzida.',
    ...
    paymentLinkErrorMsg:'Não foi possível gerar o link de pagamento agora. Tente novamente ou entre em contato pelo WhatsApp.',
  ...
  es: {
    ...
    rule6:'Camas literas de tres pisos: no aptas para mayores de 50 años ni personas con movilidad reducida.',
    ...
    paymentLinkErrorMsg:'No pudimos generar el link de pago ahora. Intentá de nuevo o contactanos por WhatsApp.',
  ...
  en: {
    ...
    paymentLinkErrorMsg:'We could not generate the payment link right now. Please try again or contact us via WhatsApp.',
  ...
  fr: {
    ...
    rule6:'Lits superposés à trois niveaux : déconseillés aux personnes de plus de 50 ans ou à mobilité réduite.',
    ...
    paymentLinkErrorMsg:'Impossible de générer le lien de paiement pour le moment. Réessayez ou contactez-nous par WhatsApp.',
  ...
  de: {
    ...
    rule6:'Dreistöckige Etagenbetten: nicht geeignet für Gäste über 50 oder mit eingeschränkter Mobilität.',
    ...
    paymentLinkErrorMsg:'Der Zahlungslink konnte gerade nicht erstellt werden. Bitte erneut versuchen oder uns per WhatsApp kontaktieren.',
  ...
  it: {
    ...
    paymentLinkErrorMsg:'Non è stato possibile generare il link di pagamento in questo momento. Riprova o contattaci via WhatsApp.',
