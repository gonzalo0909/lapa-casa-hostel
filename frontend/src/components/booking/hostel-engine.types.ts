...
export const T = {
  pt: {
    ...
    gpOr:'Ou pagar em grupo',gpTitle:'Um link para cada convidado',
    gpDesc:'Cada convidado tem seu próprio link, de uso único. Envie um para cada pessoa — não é para reenviar o mesmo link duas vezes.',
  ...
  es: {
    ...
    gpDesc:'Cada invitado tiene su propio link, de un solo uso. Mandale uno distinto a cada persona — no reenvíes el mismo link dos veces.',
  ...
  en: {
    ...
    gpTitle:'One link per guest',
    gpDesc:'Each guest has their own single-use link. Send one to each person — don\'t forward the same link twice.',
  ...
  fr: {
    ...
    gpTitle:'Un lien par invité',
    gpDesc:'Chaque invité a son propre lien, à usage unique. Envoyez-en un différent à chaque personne — ne renvoyez pas deux fois le même lien.',
  ...
  de: {
    ...
    gpTitle:'Ein Link pro Gast',
    gpDesc:'Jeder Gast hat seinen eigenen Link, nur einmal verwendbar. Schicke jeder Person einen anderen — denselben Link nicht zweimal weiterleiten.',
  ...
  it: {
    ...
    gpTitle:'Un link per ogni ospite',
    gpDesc:'Ogni ospite ha il proprio link, monouso. Mandane uno diverso a ciascuna persona — non inoltrare lo stesso link due volte.',
