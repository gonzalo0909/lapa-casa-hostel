...
import { RoomTypes } from '@/components/admin/room-types';
...
type Tab = 'dashboard' | 'pricing' | 'rooms' | 'blocking' | 'ical';
  ...
  return (
    <div className="max-w-5xl mx-auto px-4 py-8">
      ...
      <div>
        ...
        {activeTab === 'rooms' && <RoomTypes locale={locale} />}
