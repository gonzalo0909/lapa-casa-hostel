...
function T(key: string, locale: string): string {
  const t: Record<string, Record<string, string>> = {
    pt: {
      ...
      familyTwelve: 'Misto Grande',
      familySeven: 'Misto Pequeno',
    ...
    es: {
      ...
      familyTwelve: 'Mixto Grande',
      familySeven: 'Mixto Chico',
    ...
    en: {
      ...
      familyTwelve: 'Mixed Large',
      familySeven: 'Mixed Small',
    ...
    fr: {
      ...
      familyTwelve: 'Mixte Grand',
      familySeven: 'Mixte Petit',
    ...
    de: {
      ...
      familyTwelve: 'Gemischt Groß',
      familySeven: 'Gemischt Klein',
