 ...
 * mrh1308 -- acá no queda nada de esa interfaz, tampoco LandingSection
 * (contenido de presentación específico del hostel: "El hostel", 45
 * camas, dirección del hostel, OTAs) -- quedaba pegado entre el selector
 * y el motor de apartamentos. El panel "Hostel" del hero se mantiene
 * visible (fiel a la maqueta) pero sin acción: no hay motor al que
 * llevarlo en esta rama.
 */
