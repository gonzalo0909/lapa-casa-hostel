      ...
      <div className="space-y-3">
        ...
        <div className="bg-blue-50 dark:bg-blue-950/40 rounded-lg p-4 space-y-3">
          <div className="flex justify-between items-center">
            <div>
              <p className="font-medium text-blue-900 dark:text-blue-200">{T('depositLabel', locale)}</p>
              <p className="text-sm text-blue-700 dark:text-blue-400">{depositPercentage.toFixed(0)}% {T('ofTotal', locale)}</p>
            </div>
            <span className="text-xl font-bold text-blue-900 dark:text-blue-200">{formatCurrency(depositAmount)}</span>
          </div>
        ...
        <div className="bg-card rounded-lg p-4 space-y-2 border border-border">
          <div className="flex justify-between items-center">
            <div>
              <p className="font-medium text-foreground">{T('remainingLabel', locale)}</p>
              <p className="text-sm text-muted-foreground">{(100 - depositPercentage).toFixed(0)}% {T('ofTotal', locale)}</p>
            </div>
