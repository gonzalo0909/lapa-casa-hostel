...
// Funções puras do motor de reservas de hostel — sem efeitos colaterais.
...
export function calcPrice(
  ...
  return {
    nights, beds: totalB, season, pbn, subtotal,
    disc, discAmt: subtotal * disc, total, deposit: total * 0.3,
  };
}
