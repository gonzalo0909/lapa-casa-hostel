  ...
  "relative w-full rounded-lg border p-4 [&>svg~*]:pl-7 [&>svg+div]:translate-y-[-3px] [&>svg]:absolute [&>svg]:left-4 [&>svg]:top-4 [&>svg]:text-foreground",
  {
    variants: {
      variant: {
        ...
        booking:
          "border-purple-500/50 text-purple-700 bg-purple-50 [&>svg]:text-purple-600",
        payment:
...
>(({ className, variant, dismissible, onDismiss, children, ...props }, ref) => (
  ...
  >
    ...
    {dismissible && (
      <button
        onClick={onDismiss}
        className="absolute right-2 top-2 rounded-md p-1 hover:bg-black/5 focus:outline-none focus:ring-2 focus:ring-ring"
...
// Iconos específicos para diferentes tipos de alertas
const AlertIcons = {
  Success: () => (
